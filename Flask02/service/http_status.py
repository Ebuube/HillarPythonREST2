"""
HttpStatus codes as enumerable
"""
...
class HttpStatus(Enum):
    """
    Different status codes and description
    """
    continue_100 = 100
    ...
    def is_informational(cls, status_code):
        """
        Return true if status code is only an information
        """
    ...
    def is_success(status_code):
        """
        Return true if status code means successfull
        """
    ...
    def is_redirect(status_code):
        """
        Return true if status code means redirect
        """
    ...
    def is_client_error(status_code):
        """
        Return true if status code means there was client error
        """
    ...
    def is_server_error(status_code):
        """
        Return true if status code means there was a server error
        """
